...
export class ModifierconnaissanceComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<ModifierconnaissanceComponent>,
              @Inject(MAT_DIALOG_DATA) public data: Connaissance,
              private cnservice : ConnaissanceService
  ) { }
